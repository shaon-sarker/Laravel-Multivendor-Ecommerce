      ...
      <div class="row">
                ...
                <div class="panel-body">
                    <form action="{{ route('seller.profile.update',Auth::guard('seller')->user()->id) }}" method="post">
                      @csrf
                        ...
                        <input type="text" name="name" class="form-control" value="{{ Auth::guard('seller')->user()->name }}" placeholder="Name" id=""><br>
                        <label for="" class="form-label">Email</label>
                        <input type="text" name="email" class="form-control" value="{{ Auth::guard('seller')->user()->email }}" placeholder="Email" id=""><br>
        ...
        <div class="col-md-6">
          <div class="panel panel-border panel-dark">
              ...
              <div class="panel-body">
                  <form action="{{ route('seller.password.update',Auth::guard('seller')->user()->id) }}" method="post">
                    @csrf
